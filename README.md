...
To help make events and outcomes concrete, there is a graphical display of what is happening in the dungeon room. In particular where the characters, creatures, and treasure chests are. For navigating freeling around the dungeon and rooms there will be a Text-User-Interface (or TUI) where the player will type in their actions. 
